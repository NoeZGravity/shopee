...
if(isset($_GET['timkiem'])) {
        $cantim = $_GET['tentimkiem'];
        $sql_search = "SELECT * FROM tblpro where pro_name LIKE '%" .$cantim. "%' ";
        $kq = mysqli_query($conn, $sql_search);
        $_SESSION['$search_pro '] = $kq;

    }else {
        $cantim = '';
        $sql_search = "SELECT * FROM tblpro LIMIT 5 ";
        $kq = mysqli_query($conn, $sql_search);
        $_SESSION['$search_pro '] = $kq;
        ...
        <header class="header">
            ...
            <div class="header-with-search">
                ...
                <div class="header__search">
                    ...
                    <button type="submit" name="timkiem" value="Search" class="header__search-btn "><i class=" header__search-btn-icon fas fa-search"></i></button>
                    </form>  
